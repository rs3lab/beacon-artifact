{
  "atomic_add/or/and/xor: precision marking test",
  .insns = {
    BPF_CALL_REL(1),
    BPF_EXIT_INSN(),
    ...
    BPF_MOV64_REG(BPF_REG_3, BPF_REG_10),
    BPF_ATOMIC_OP(BPF_W, BPF_OR, BPF_REG_3, BPF_REG_7, -120),
	BPF_ATOMIC_OP(BPF_W, BPF_OR | BPF_FETCH, BPF_REG_3, BPF_REG_7, -120),
